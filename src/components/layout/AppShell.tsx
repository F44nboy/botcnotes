...
export function AppShell({children}: AppShellProps) {
  ...
  return (
    <div className={`min-h-screen text-neutral-200 bg-[url(/background.webp)] bg-cover bg-center px-2 sm:px-3 md:px-5 pt-4 flex flex-col`}>
      ...
      <main className="pt-3 flex-1 min-h-0 overflow-y-auto overflow-x-hidden">
